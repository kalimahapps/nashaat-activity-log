...
class NashaatSettings {
	 ...
	 * @return void
	 */
	public function nashaat_cron_purge_after_days() {
		global $wpdb;
	 ...
	 * @return void
	 */
	public function render_setting_outline() {
	 ...
	 * @return void
	 */
	public function nashaat_settings_init() {

		register_setting( 'nashaat-settings', $this->settings_slug );

		$this->add_section( 'general_settings' );
	}
	 ...
	 */
	private function get_field_value( string $id ) {
	 ...
	 * @return void
	 */
	private function general_settings_callback( string $section_key ) {
	 ...
	 * @return void
	 */
	private function add_section( string $key ) {
	 ...
	 * @return void
	 */
	private function add_number_field( array $args ) {
		$this->add_field( 'number', $args );
	}
	 ...
	 * @return void
	 */
	private function add_switch_field( array $args ) {
		$this->add_field( 'switch', $args );
	}
	 ...
	 * @return void
	 */
	private function add_html_field( array $args ) {
		$this->add_field( 'html', $args );
	}
	 ...
	 * @return void
	 */
	private function add_field( string $type, array $args ) {
		...
		$args['value'] = $this->get_field_value( $id );
	 ...
	 * @return void
	 */
	public function render_switch_field( array $args ) {
	 ...
	 * @return void
	 */
	public function render_html_field( array $args ) {
