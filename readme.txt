...
== Planned Features ==
I am planning to add the following features. There is time or version set yet for these features. Since the plugin is in early releases I am focusing on fixing bugs, updating code and optimizing performance.
- Multisite support.
- Popular plugins support: WooCommerce, Yoast SEO, Gravity Forms, Advanced Custom Fields (ACF), WPForms, bbPress, Contact Form 7, Easy Digital Downloads and any other popular plugins that might be requested.
